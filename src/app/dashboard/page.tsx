...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--ml-gray-200)' }}>
      {/* Header */}
      <header className="ml-bg-primary shadow-sm border-b" style={{ borderColor: 'var(--ml-gray-400)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              {sessionLoading ? (
                <div className="text-sm" style={{ color: 'var(--ml-gray-900)' }}>
                  Verificando sessão...
                </div>
              ) : instagramSession ? (
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-xs" style={{ color: 'var(--ml-gray-900)' }}>
